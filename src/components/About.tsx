...
export default function About() {
  return (
    <div
      className="mt-14 md:mt-20 mb-14 md:mb-20 scroll-mt-28 md:scroll-mt-32"
      id="about"
    >
      <h1 className="scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl text-slate-800 dark:text-slate-300">
        Hi, I am{" "}
        <span className="text-sky-600 dark:text-sky-500">Rizal Pradanaaa</span>
        👋.
      </h1>
      ...
      <blockquote className=" p-5 italic md:text-lg text-slate-600 lg:w-2/3 mx-auto dark:text-slate-300">
        "Informatics graduate with an interest in web programming, knowledgeable
        in web application development, and familiar with using modern
        technologies;"
      </blockquote>
      ...
      <div className="flex flex-inline gap-4 mx-auto items-center justify-center my-2 dark:text-slate-300">
        ...
        <a
          href="https://www.linkedin.com/in/rizal-nawang-pradana/"
          target="_blank"
        >
          <svg
            className="h-8 w-8 text-slate-600 hover:text-sky-600"
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogDescription>
              ...
              >
                <img
                  src="/img/rizal-pradana-cv-english.png"
          ...
          <AlertDialogFooter>
            <AlertDialogCancel className="text-white bg-sky-600 hover:bg-sky-700">
              Close
            </AlertDialogCancel>
          </AlertDialogFooter>
        </AlertDialogContent>
