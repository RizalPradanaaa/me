export default function About() {
    return (
        <div className='mt-16 md:mt-24 mb-14 md:mb-20'>
            ...
            <h2 className="scroll-m-20 mt-5 text-2xl md:text-3xl font-bold tracking-tight first:mt-0 underline-offset-4">
            A Web Programmer;
            </h2>
            <blockquote className=" p-5 italic md:text-lg text-slate-600 lg:w-2/3 mx-auto">
            ...
            <div className="flex flex-inline gap-4 mx-auto items-center justify-center mt-2">
