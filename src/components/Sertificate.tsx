...
export default function Sertificate() {
  return (
    <div className="mt-16 scroll-mt-28 md:scroll-mt-32" id="sertificate">
    <h1 className="scroll-m-20 text-3xl md:text-4xl font-extrabold tracking-tight lg:text-5xl text-slate-800 dark:text-slate-300">
        &lt;Sertificate/&gt;
    </h1>
    ...
    <Carousel className="my-12 mx-8" >
        <CarouselContent>
            <CarouselItem className="md:basis-1/2 lg:basis-1/3">
                <Card className="shadow-md border-2 transition-all pt-6 dark:bg-slate-900 dark:border-slate-500 dark:border-2 dark:rounded-md">
                    <CardContent>
            ...
            <CarouselItem className="md:basis-1/2 lg:basis-1/3">
                <Card className="shadow-md border-2 transition-all pt-4 -pb-10 dark:bg-slate-900 dark:border-slate-500 dark:border-2 dark:rounded-md">
                    <CardContent>
